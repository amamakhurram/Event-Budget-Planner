...
st.markdown(
    ...
    <style>
        ...
        .stButton > button { background-color: #16A085; color: white; font-size: 16px; border-radius: 10px; padding: 10px; }
        .stSelectbox, .stSlider, .stTextInput { margin-bottom: 10px; }
        .sidebar .sidebar-content { background-color: #D5DBDB; padding: 10px; border-radius: 10px; }
...
try:
    ...
    if page == "Home":
        ...
        if "df" in st.session_state:
            ...
            st.write(df.style.set_properties(**{"background-color": "#F8F9F9", "border-radius": "10px", "padding": "10px"}))
